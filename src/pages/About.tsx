  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="Learn about Alumina Engineering Pvt. Ltd., Mumbai's trusted supplier of premium architectural products from Dormakaba, Skyfold, McKeon and Merino Toilet Partitions."
        ...
        <div className="container">
          <div className={`max-w-3xl mx-auto transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              ...
              <p>
                We represent some of the world's finest brands — Dormakaba, Skyfold, McKeon Door Company, and Merino Toilet Partitions — bringing cutting-edge architectural products to India's most prestigious projects.
              </p>
              <p>
